...
Thank you for your interest in contributing to **ForMD**! All contributions — bug reports, feature requests, documentation improvements, and code changes — are welcome.
...
See the [Desktop App](Formd-Desktop) wiki page for full instructions.
...
└── formd-desktop/            # Neutralinojs desktop app
    ├── package.json
