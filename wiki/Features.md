...
A detailed reference for every feature supported by **ForMD**.
...
ForMD implements the **GitHub Flavored Markdown (GFM)** specification:
...
ForMD uses **CSS custom properties** (CSS variables) for theming, enabling instant zero-flicker theme switching. Both themes are carefully tuned for comfortable reading and editing.
