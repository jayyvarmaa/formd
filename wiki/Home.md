...
Welcome to the **ForMD** wiki — your comprehensive reference for installation, configuration, and usage of the ForMD application.
...
| [Desktop App](Formd-Desktop) | Build and run the native desktop application |
