...
This page documents all configuration files and customizable settings in **ForMD**.
...
- [Desktop App — neutralino.config.json](#Formd-Desktop--neutralinoconfigjson)
- [Desktop App — package.json Scripts](#Formd-Desktop--packagejson-scripts)
...
| `container_name` | `formd` | Container name |
...
Located at `formd-desktop/neutralino.config.json`.
...
Located at `formd-desktop/package.json`.
