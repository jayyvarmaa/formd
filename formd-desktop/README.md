...
Build artifacts will be output to `formd-desktop/output/`.
...
| Asset | Description |
| ----- | ----------- |
| `formd-win_x64.exe` | Windows x64 executable |
| `formd-linux_x64.tar.gz` | Linux x64 executable (tarball) |
| `formd-linux_arm64.tar.gz` | Linux ARM64 executable (tarball) |
| `formd-mac_*.tar.gz` | macOS executables (tarball) |
| `formd-release.zip` | Portable bundle with `resources.neu` (all platforms) |
