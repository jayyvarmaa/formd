 ...
 * ForMD
 * 
 * Copyright 2024 ThisIs_Developer
 * Copyright 2024 ForMD Contributors
 * 
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const sampleMarkdown = `# Welcome to ForMD
...
| Feature                  | ForMD (Ours)           | Other Markdown Editors  |
|:-------------------------|:----------------------:|:-----------------------:|
...
This is a fully client-side application. Your content never leaves your browser and stays secure on your device.`;
  ...
  const STORAGE_KEY = 'forMDTabs';
  const ACTIVE_TAB_KEY = 'forMDActiveTab';
  const UNTITLED_COUNTER_KEY = 'forMDUntitledCounter';
  let tabs = [];
